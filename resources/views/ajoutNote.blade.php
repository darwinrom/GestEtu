...
<div class="container">
    <h1 class="blue-text"> Ajout d'une note</h1>
    <div class="row">
        <form action="{{route("ajoutTraitement")}}" method="post">

            {!! csrf_field() !!}
            <div class="row">
                <div class="input-field col s6">
                    <select name="matiere">
                        <option  value="" disabled selected>Choisissez votre matiere</option>
                        @foreach ($data as $matiere)
                            <option name="matiere" value={{ $matiere->code_mat }} >{{ $matiere->lib_mat }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input type="number" min="0" max="20" name="note" id="" class="validate">
