...
<div class="container">
    <h1 class="blue-text">Modifier d'une note</h1>
    <div class="row">
        <form action="{{route("traitNM")}}" method="post">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        <input type="hidden" value="{{$data->get(0)->code_mat}}" name="code_mat"/>
                        <input type="number" min="0" max="20" name="note" id="" value="{{$data->get(0)->note}}" class="validate">
